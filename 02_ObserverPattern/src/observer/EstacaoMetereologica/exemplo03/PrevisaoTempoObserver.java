 ...
 *
 */
public class PrevisaoTempoObserver implements Observer, DisplayExibicao {
	...
	public PrevisaoTempoObserver(Subject objetoObservavel) {
	...
	@Override
	public void exibir() {
		System.out.println("***************  OBSERVADOR - PREVISAO DO TEMPO ***************");
		System.out.println();
