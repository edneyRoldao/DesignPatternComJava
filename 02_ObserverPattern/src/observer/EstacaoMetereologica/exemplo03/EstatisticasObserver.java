 ...
 *
 */
public class EstatisticasObserver implements Observer, DisplayExibicao {
	...
	public EstatisticasObserver(Subject objetoObservavel) {
	...
	@Override
	public void exibir() {
		System.out.println("***************  OBSERVADOR - ESTATISTICAS ***************");
		System.out.println();
